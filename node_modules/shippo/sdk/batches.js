...
class Batches extends sdks_js_1.ClientSDK {
    ...
    async get(batchId, options) {
        return (0, fp_js_1.unwrapAsync)((0, batchesGet_js_1.batchesGet)(this, batchId, options));
    }
    /**
    ...
    async addShipments(batchId, requestBody, options) {
        return (0, fp_js_1.unwrapAsync)((0, batchesAddShipments_js_1.batchesAddShipments)(this, batchId, requestBody, options));
    }
    /**
     * Purchase a batch
     *
    ...
    async removeShipments(batchId, requestBody, options) {
        return (0, fp_js_1.unwrapAsync)((0, batchesRemoveShipments_js_1.batchesRemoveShipments)(this, batchId, requestBody, options));
    }
}
