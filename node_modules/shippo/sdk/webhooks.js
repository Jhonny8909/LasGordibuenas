...
class Webhooks extends sdks_js_1.ClientSDK {
     ...
     */
    async updateWebhook(webhookId, webhookUpdateRequest, options) {
        return (0, fp_js_1.unwrapAsync)((0, webhooksUpdateWebhook_js_1.webhooksUpdateWebhook)(this, webhookId, webhookUpdateRequest, options));
    }
    /**
