...
export declare class Batches extends ClientSDK {
    /**
     * Create a batch
     *
     * @remarks
     ...
     */
    create(request: components.BatchCreateRequest, options?: RequestOptions): Promise<components.Batch>;
    /**
     * Retrieve a batch
     *
     * @remarks
     ...
     */
    get(batchId: string, options?: RequestOptions): Promise<components.Batch>;
    /**
     ...
     */
    addShipments(batchId: string, requestBody: Array<components.BatchShipmentCreateRequest>, options?: RequestOptions): Promise<components.Batch>;
    /**
     * Purchase a batch
     *
     * @remarks
     ...
     */
    purchase(batchId: string, options?: RequestOptions): Promise<components.Batch>;
    /**
     ...
     */
    removeShipments(batchId: string, requestBody: Array<string>, options?: RequestOptions): Promise<components.Batch>;
}
