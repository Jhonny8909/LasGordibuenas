...
export declare class UserParcelTemplates extends ClientSDK {
    /**
     ...
     */
    list(options?: RequestOptions): Promise<components.UserParcelTemplateList>;
    /**
     ...
     */
    create(request: components.UserParcelTemplateCreateRequest, options?: RequestOptions): Promise<components.UserParcelTemplate>;
    /**
     ...
     */
    delete(userParcelTemplateObjectId: string, options?: RequestOptions): Promise<void>;
    /**
     ...
     */
    get(userParcelTemplateObjectId: string, options?: RequestOptions): Promise<components.UserParcelTemplate>;
    /**
     ...
     */
    update(userParcelTemplateObjectId: string, userParcelTemplateUpdateRequest?: components.UserParcelTemplateUpdateRequest | undefined, options?: RequestOptions): Promise<components.UserParcelTemplate>;
}
//# sourceMappingURL=userparceltemplates.d.ts.map