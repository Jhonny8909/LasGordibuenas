...
export declare class TrackingStatus extends ClientSDK {
    /**
     ...
     */
    create(carrier: string, trackingNumber: string, metadata?: string | undefined, options?: RequestOptions): Promise<components.Track>;
    /**
     ...
     */
    get(trackingNumber: string, carrier: string, options?: RequestOptions): Promise<components.Track>;
}
