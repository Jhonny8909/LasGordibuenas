...
export declare class Webhooks extends ClientSDK {
     ...
     */
    createWebhook(request: components.WebhookUpdateRequest, options?: RequestOptions): Promise<components.Webhook>;
    /**
     * List all webhooks
     *
     * @remarks
     ...
     */
    listWebhooks(options?: RequestOptions): Promise<components.WebhookPaginatedList>;
    /**
     ...
     */
    getWebhook(webhookId: string, options?: RequestOptions): Promise<components.Webhook>;
    /**
     ...
     */
    updateWebhook(webhookId: string, webhookUpdateRequest: components.WebhookUpdateRequest, options?: RequestOptions): Promise<components.Webhook>;
    /**
