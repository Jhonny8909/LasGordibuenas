...
class RatesAtCheckout extends sdks_js_1.ClientSDK {
     ...
     */
    async getDefaultParcelTemplate(options) {
        return (0, fp_js_1.unwrapAsync)((0, ratesAtCheckoutGetDefaultParcelTemplate_js_1.ratesAtCheckoutGetDefaultParcelTemplate)(this, options));
    }
    /**
     ...
     */
    async updateDefaultParcelTemplate(objectId, options) {
        return (0, fp_js_1.unwrapAsync)((0, ratesAtCheckoutUpdateDefaultParcelTemplate_js_1.ratesAtCheckoutUpdateDefaultParcelTemplate)(this, objectId, options));
    }
    /**
     ...
     */
    async deleteDefaultParcelTemplate(options) {
        return (0, fp_js_1.unwrapAsync)((0, ratesAtCheckoutDeleteDefaultParcelTemplate_js_1.ratesAtCheckoutDeleteDefaultParcelTemplate)(this, options));
    }
}
