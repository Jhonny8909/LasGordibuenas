...
/** @internal */
export declare const UserParcelTemplateUpdateRequest$inboundSchema: z.ZodType<UserParcelTemplateUpdateRequest, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserParcelTemplateUpdateRequest$outboundSchema: z.ZodType<UserParcelTemplateUpdateRequest$Outbound, z.ZodTypeDef, UserParcelTemplateUpdateRequest>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserParcelTemplateUpdateRequest$ {
    /** @deprecated use `UserParcelTemplateUpdateRequest$inboundSchema` instead. */
    const inboundSchema: z.ZodType<UserParcelTemplateUpdateRequest, z.ZodTypeDef, unknown>;
    /** @deprecated use `UserParcelTemplateUpdateRequest$outboundSchema` instead. */
    const outboundSchema: z.ZodType<UserParcelTemplateUpdateRequest$Outbound, z.ZodTypeDef, UserParcelTemplateUpdateRequest>;
    /** @deprecated use `UserParcelTemplateUpdateRequest$Outbound` instead. */
    type Outbound = UserParcelTemplateUpdateRequest$Outbound;
}
//# sourceMappingURL=userparceltemplateupdaterequest.d.ts.map