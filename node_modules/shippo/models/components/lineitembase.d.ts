...
/** @internal */
export declare const LineItemBase$inboundSchema: z.ZodType<LineItemBase, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const LineItemBase$outboundSchema: z.ZodType<LineItemBase$Outbound, z.ZodTypeDef, LineItemBase>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace LineItemBase$ {
    /** @deprecated use `LineItemBase$inboundSchema` instead. */
    const inboundSchema: z.ZodType<LineItemBase, z.ZodTypeDef, unknown>;
    /** @deprecated use `LineItemBase$outboundSchema` instead. */
    const outboundSchema: z.ZodType<LineItemBase$Outbound, z.ZodTypeDef, LineItemBase>;
    /** @deprecated use `LineItemBase$Outbound` instead. */
    type Outbound = LineItemBase$Outbound;
}
//# sourceMappingURL=lineitembase.d.ts.map