...
exports.ShippoAccount$ = exports.ShippoAccount$outboundSchema = exports.ShippoAccount$inboundSchema = void 0;
const z = __importStar(require("zod"));
const primitives_js_1 = require("../../lib/primitives.js");
/** @internal */
exports.ShippoAccount$inboundSchema = z.object({
    email: z.string(),
    first_name: z.string(),
    last_name: z.string(),
...
/** @internal */
exports.ShippoAccount$outboundSchema = z.object({
    email: z.string(),
    firstName: z.string(),
    lastName: z.string(),
 ...
 */
var ShippoAccount$;
(function (ShippoAccount$) {
    /** @deprecated use `ShippoAccount$inboundSchema` instead. */
    ShippoAccount$.inboundSchema = exports.ShippoAccount$inboundSchema;
    /** @deprecated use `ShippoAccount$outboundSchema` instead. */
    ShippoAccount$.outboundSchema = exports.ShippoAccount$outboundSchema;
})(ShippoAccount$ || (exports.ShippoAccount$ = ShippoAccount$ = {}));
//# sourceMappingURL=shippoaccount.js.map