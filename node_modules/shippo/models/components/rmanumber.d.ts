...
/** @internal */
export declare const RmaNumber$inboundSchema: z.ZodType<RmaNumber, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const RmaNumber$outboundSchema: z.ZodType<RmaNumber$Outbound, z.ZodTypeDef, RmaNumber>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace RmaNumber$ {
    /** @deprecated use `RmaNumber$inboundSchema` instead. */
    const inboundSchema: z.ZodType<RmaNumber, z.ZodTypeDef, unknown>;
    /** @deprecated use `RmaNumber$outboundSchema` instead. */
    const outboundSchema: z.ZodType<RmaNumber$Outbound, z.ZodTypeDef, RmaNumber>;
    /** @deprecated use `RmaNumber$Outbound` instead. */
    type Outbound = RmaNumber$Outbound;
}
//# sourceMappingURL=rmanumber.d.ts.map