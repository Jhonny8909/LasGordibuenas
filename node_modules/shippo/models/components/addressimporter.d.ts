...
/** @internal */
export declare const AddressImporter$inboundSchema: z.ZodType<AddressImporter, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const AddressImporter$outboundSchema: z.ZodType<AddressImporter$Outbound, z.ZodTypeDef, AddressImporter>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace AddressImporter$ {
    /** @deprecated use `AddressImporter$inboundSchema` instead. */
    const inboundSchema: z.ZodType<AddressImporter, z.ZodTypeDef, unknown>;
    /** @deprecated use `AddressImporter$outboundSchema` instead. */
    const outboundSchema: z.ZodType<AddressImporter$Outbound, z.ZodTypeDef, AddressImporter>;
    /** @deprecated use `AddressImporter$Outbound` instead. */
    type Outbound = AddressImporter$Outbound;
}
//# sourceMappingURL=addressimporter.d.ts.map