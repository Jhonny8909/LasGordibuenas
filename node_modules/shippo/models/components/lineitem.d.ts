...
/** @internal */
export declare const LineItem$outboundSchema: z.ZodType<LineItem$Outbound, z.ZodTypeDef, LineItem>;
/**
 * @internal
...
export declare namespace LineItem$ {
    ...
    const inboundSchema: z.ZodType<LineItem, z.ZodTypeDef, unknown>;
    /** @deprecated use `LineItem$outboundSchema` instead. */
    const outboundSchema: z.ZodType<LineItem$Outbound, z.ZodTypeDef, LineItem>;
    /** @deprecated use `LineItem$Outbound` instead. */
    type Outbound = LineItem$Outbound;
}
