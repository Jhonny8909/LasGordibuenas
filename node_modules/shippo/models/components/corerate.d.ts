...
/** @internal */
export declare const CoreRate$inboundSchema: z.ZodType<CoreRate, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const CoreRate$outboundSchema: z.ZodType<CoreRate$Outbound, z.ZodTypeDef, CoreRate>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace CoreRate$ {
    /** @deprecated use `CoreRate$inboundSchema` instead. */
    const inboundSchema: z.ZodType<CoreRate, z.ZodTypeDef, unknown>;
    /** @deprecated use `CoreRate$outboundSchema` instead. */
    const outboundSchema: z.ZodType<CoreRate$Outbound, z.ZodTypeDef, CoreRate>;
    /** @deprecated use `CoreRate$Outbound` instead. */
    type Outbound = CoreRate$Outbound;
}
//# sourceMappingURL=corerate.d.ts.map