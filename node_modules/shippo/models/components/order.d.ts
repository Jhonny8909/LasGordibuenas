...
/** @internal */
export declare const Transactions$inboundSchema: z.ZodType<Transactions, z.ZodTypeDef, unknown>;
/** @internal */
export type Transactions$Outbound = {};
/** @internal */
export declare const Transactions$outboundSchema: z.ZodType<Transactions$Outbound, z.ZodTypeDef, Transactions>;
/**
 * @internal
...
export declare namespace Transactions$ {
    ...
    const inboundSchema: z.ZodType<Transactions, z.ZodTypeDef, unknown>;
    /** @deprecated use `Transactions$outboundSchema` instead. */
    const outboundSchema: z.ZodType<Transactions$Outbound, z.ZodTypeDef, Transactions>;
    /** @deprecated use `Transactions$Outbound` instead. */
    type Outbound = Transactions$Outbound;
}
/** @internal */
