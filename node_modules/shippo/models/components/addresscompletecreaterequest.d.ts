...
/** @internal */
export declare const AddressCompleteCreateRequest$inboundSchema: z.ZodType<AddressCompleteCreateRequest, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const AddressCompleteCreateRequest$outboundSchema: z.ZodType<AddressCompleteCreateRequest$Outbound, z.ZodTypeDef, AddressCompleteCreateRequest>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace AddressCompleteCreateRequest$ {
    /** @deprecated use `AddressCompleteCreateRequest$inboundSchema` instead. */
    const inboundSchema: z.ZodType<AddressCompleteCreateRequest, z.ZodTypeDef, unknown>;
    /** @deprecated use `AddressCompleteCreateRequest$outboundSchema` instead. */
    const outboundSchema: z.ZodType<AddressCompleteCreateRequest$Outbound, z.ZodTypeDef, AddressCompleteCreateRequest>;
    /** @deprecated use `AddressCompleteCreateRequest$Outbound` instead. */
    type Outbound = AddressCompleteCreateRequest$Outbound;
}
