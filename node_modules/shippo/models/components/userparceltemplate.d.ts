...
/** @internal */
export declare const UserParcelTemplate$inboundSchema: z.ZodType<UserParcelTemplate, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserParcelTemplate$outboundSchema: z.ZodType<UserParcelTemplate$Outbound, z.ZodTypeDef, UserParcelTemplate>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserParcelTemplate$ {
    /** @deprecated use `UserParcelTemplate$inboundSchema` instead. */
    const inboundSchema: z.ZodType<UserParcelTemplate, z.ZodTypeDef, unknown>;
    /** @deprecated use `UserParcelTemplate$outboundSchema` instead. */
    const outboundSchema: z.ZodType<UserParcelTemplate$Outbound, z.ZodTypeDef, UserParcelTemplate>;
    /** @deprecated use `UserParcelTemplate$Outbound` instead. */
    type Outbound = UserParcelTemplate$Outbound;
}
//# sourceMappingURL=userparceltemplate.d.ts.map