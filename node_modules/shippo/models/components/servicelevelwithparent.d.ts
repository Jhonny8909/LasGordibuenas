...
import { ServiceLevel, ServiceLevel$Outbound } from "./servicelevel.js";
/**
...
/** @internal */
export declare const ServiceLevelWithParent$inboundSchema: z.ZodType<ServiceLevelWithParent, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const ServiceLevelWithParent$outboundSchema: z.ZodType<ServiceLevelWithParent$Outbound, z.ZodTypeDef, ServiceLevelWithParent>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace ServiceLevelWithParent$ {
    /** @deprecated use `ServiceLevelWithParent$inboundSchema` instead. */
    const inboundSchema: z.ZodType<ServiceLevelWithParent, z.ZodTypeDef, unknown>;
    /** @deprecated use `ServiceLevelWithParent$outboundSchema` instead. */
    const outboundSchema: z.ZodType<ServiceLevelWithParent$Outbound, z.ZodTypeDef, ServiceLevelWithParent>;
    /** @deprecated use `ServiceLevelWithParent$Outbound` instead. */
    type Outbound = ServiceLevelWithParent$Outbound;
}
//# sourceMappingURL=servicelevelwithparent.d.ts.map