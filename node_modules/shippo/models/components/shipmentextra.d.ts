...
import { Alcohol, Alcohol$Outbound } from "./alcohol.js";
import { Billing, Billing$Outbound } from "./billing.js";
import { Cod, Cod$Outbound } from "./cod.js";
import { CustomerReference, CustomerReference$Outbound } from "./customerreference.js";
import { DangerousGoodsObject, DangerousGoodsObject$Outbound } from "./dangerousgoodsobject.js";
import { DepartmentNumber, DepartmentNumber$Outbound } from "./departmentnumber.js";
import { DryIce, DryIce$Outbound } from "./dryice.js";
import { Insurance, Insurance$Outbound } from "./insurance.js";
import { InvoiceNumber, InvoiceNumber$Outbound } from "./invoicenumber.js";
import { PoNumber, PoNumber$Outbound } from "./ponumber.js";
import { RmaNumber, RmaNumber$Outbound } from "./rmanumber.js";
import { ShipmentExtraLasershipAttributesEnum } from "./shipmentextralasershipattributesenum.js";
import { ShipmentExtraReturnServiceTypeLasershipEnum } from "./shipmentextrareturnservicetypelasershipenum.js";
import { ShipmentExtraReturnServiceTypeUPSEnum } from "./shipmentextrareturnservicetypeupsenum.js";
import { UPSReferenceFields, UPSReferenceFields$Outbound } from "./upsreferencefields.js";
/**
 ...
 */
export declare const AncillaryEndorsement: {
 ...
 */
export declare const DangerousGoodsCode: {
    readonly One: "01";
    readonly Two: "02";
    readonly Three: "03";
    readonly Four: "04";
 ...
 */
export declare const PreferredDeliveryTimeframe: {
    readonly TenMillionOneThousandTwoHundred: "10001200";
    readonly TwelveMillionOneThousandFourHundred: "12001400";
    readonly FourteenMillionOneThousandSixHundred: "14001600";
    readonly SixteenMillionOneThousandEightHundred: "16001800";
    readonly EighteenMillionTwoThousand: "18002000";
    readonly NineteenMillionTwoThousandOneHundred: "19002100";
};
/**
 * Required for DHL Germany Paket Sameday. Designates a desired timeframe for delivery. Format is `HHMMHHMM`
 */
 ...
 */
export type ReturnServiceType = ShipmentExtraReturnServiceTypeUPSEnum | ShipmentExtraReturnServiceTypeLasershipEnum;
/**
 ...
 */
export declare const SignatureConfirmation: {
    readonly Standard: "STANDARD";
    readonly Adult: "ADULT";
    readonly Certified: "CERTIFIED";
    readonly Indirect: "INDIRECT";
    readonly CarrierConfirmation: "CARRIER_CONFIRMATION";
};
/**
 * Request standard or adult signature confirmation. You can alternatively request Certified Mail (USPS only)
 *
...
export type ShipmentExtra = {
     ...
     * Request additional return option for return shipments (UPS and Lasership only).
     */
    returnServiceType?: ShipmentExtraReturnServiceTypeUPSEnum | ShipmentExtraReturnServiceTypeLasershipEnum | undefined;
    /**
...
/** @internal */
export declare const AncillaryEndorsement$inboundSchema: z.ZodNativeEnum<typeof AncillaryEndorsement>;
/** @internal */
export declare const AncillaryEndorsement$outboundSchema: z.ZodNativeEnum<typeof AncillaryEndorsement>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace AncillaryEndorsement$ {
...
/** @internal */
export declare const DangerousGoodsCode$inboundSchema: z.ZodNativeEnum<typeof DangerousGoodsCode>;
/** @internal */
export declare const DangerousGoodsCode$outboundSchema: z.ZodNativeEnum<typeof DangerousGoodsCode>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace DangerousGoodsCode$ {
...
/** @internal */
export declare const PreferredDeliveryTimeframe$inboundSchema: z.ZodNativeEnum<typeof PreferredDeliveryTimeframe>;
/** @internal */
export declare const PreferredDeliveryTimeframe$outboundSchema: z.ZodNativeEnum<typeof PreferredDeliveryTimeframe>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace PreferredDeliveryTimeframe$ {
...
/** @internal */
export declare const ReturnServiceType$inboundSchema: z.ZodType<ReturnServiceType, z.ZodTypeDef, unknown>;
/** @internal */
export type ReturnServiceType$Outbound = string | string;
/** @internal */
export declare const ReturnServiceType$outboundSchema: z.ZodType<ReturnServiceType$Outbound, z.ZodTypeDef, ReturnServiceType>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace ReturnServiceType$ {
    /** @deprecated use `ReturnServiceType$inboundSchema` instead. */
    const inboundSchema: z.ZodType<ReturnServiceType, z.ZodTypeDef, unknown>;
    /** @deprecated use `ReturnServiceType$outboundSchema` instead. */
    const outboundSchema: z.ZodType<string, z.ZodTypeDef, ReturnServiceType>;
    /** @deprecated use `ReturnServiceType$Outbound` instead. */
    type Outbound = ReturnServiceType$Outbound;
}
/** @internal */
export declare const SignatureConfirmation$inboundSchema: z.ZodNativeEnum<typeof SignatureConfirmation>;
/** @internal */
export declare const SignatureConfirmation$outboundSchema: z.ZodNativeEnum<typeof SignatureConfirmation>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace SignatureConfirmation$ {
...
/** @internal */
export declare const ShipmentExtra$inboundSchema: z.ZodType<ShipmentExtra, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const ShipmentExtra$outboundSchema: z.ZodType<ShipmentExtra$Outbound, z.ZodTypeDef, ShipmentExtra>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace ShipmentExtra$ {
    /** @deprecated use `ShipmentExtra$inboundSchema` instead. */
    const inboundSchema: z.ZodType<ShipmentExtra, z.ZodTypeDef, unknown>;
    /** @deprecated use `ShipmentExtra$outboundSchema` instead. */
    const outboundSchema: z.ZodType<ShipmentExtra$Outbound, z.ZodTypeDef, ShipmentExtra>;
    /** @deprecated use `ShipmentExtra$Outbound` instead. */
    type Outbound = ShipmentExtra$Outbound;
}
//# sourceMappingURL=shipmentextra.d.ts.map