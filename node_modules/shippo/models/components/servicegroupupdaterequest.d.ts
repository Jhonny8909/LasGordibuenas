...
/** @internal */
export declare const ServiceGroupUpdateRequest$inboundSchema: z.ZodType<ServiceGroupUpdateRequest, z.ZodTypeDef, unknown>;
/** @internal */
export type ServiceGroupUpdateRequest$Outbound = {
    description: string;
...
/** @internal */
export declare const ServiceGroupUpdateRequest$outboundSchema: z.ZodType<ServiceGroupUpdateRequest$Outbound, z.ZodTypeDef, ServiceGroupUpdateRequest>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace ServiceGroupUpdateRequest$ {
    /** @deprecated use `ServiceGroupUpdateRequest$inboundSchema` instead. */
    const inboundSchema: z.ZodType<ServiceGroupUpdateRequest, z.ZodTypeDef, unknown>;
    /** @deprecated use `ServiceGroupUpdateRequest$outboundSchema` instead. */
    const outboundSchema: z.ZodType<ServiceGroupUpdateRequest$Outbound, z.ZodTypeDef, ServiceGroupUpdateRequest>;
    /** @deprecated use `ServiceGroupUpdateRequest$Outbound` instead. */
    type Outbound = ServiceGroupUpdateRequest$Outbound;
}
//# sourceMappingURL=servicegroupupdaterequest.d.ts.map