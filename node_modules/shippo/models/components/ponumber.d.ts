...
/** @internal */
export declare const PoNumber$inboundSchema: z.ZodType<PoNumber, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const PoNumber$outboundSchema: z.ZodType<PoNumber$Outbound, z.ZodTypeDef, PoNumber>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace PoNumber$ {
    /** @deprecated use `PoNumber$inboundSchema` instead. */
    const inboundSchema: z.ZodType<PoNumber, z.ZodTypeDef, unknown>;
    /** @deprecated use `PoNumber$outboundSchema` instead. */
    const outboundSchema: z.ZodType<PoNumber$Outbound, z.ZodTypeDef, PoNumber>;
    /** @deprecated use `PoNumber$Outbound` instead. */
    type Outbound = PoNumber$Outbound;
}
//# sourceMappingURL=ponumber.d.ts.map