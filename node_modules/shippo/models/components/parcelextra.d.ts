...
/** @internal */
export declare const ParcelExtra$inboundSchema: z.ZodType<ParcelExtra, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const ParcelExtra$outboundSchema: z.ZodType<ParcelExtra$Outbound, z.ZodTypeDef, ParcelExtra>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace ParcelExtra$ {
    /** @deprecated use `ParcelExtra$inboundSchema` instead. */
    const inboundSchema: z.ZodType<ParcelExtra, z.ZodTypeDef, unknown>;
    /** @deprecated use `ParcelExtra$outboundSchema` instead. */
    const outboundSchema: z.ZodType<ParcelExtra$Outbound, z.ZodTypeDef, ParcelExtra>;
    /** @deprecated use `ParcelExtra$Outbound` instead. */
    type Outbound = ParcelExtra$Outbound;
}
