...
exports.serviceGroupsList = void 0;
 ...
 */
async function serviceGroupsList(client, options) {
    const input = {};
    ...
    const [result] = await M.match(M.json(200, z.array(components.ServiceGroup$inboundSchema)), M.fail([400, "4XX", "5XX"]))(response);
    if (!result.ok) {
        return result;
    }
    return result;
...
//# sourceMappingURL=serviceGroupsList.js.map