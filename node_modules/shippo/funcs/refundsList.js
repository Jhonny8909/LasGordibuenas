 ...
 */
async function refundsList(client, options) {
    const input = {};
    ...
    const [result] = await M.match(M.json(200, components.RefundPaginatedList$inboundSchema), M.fail([400, "4XX", "5XX"]))(response);
    if (!result.ok) {
        return result;
    }
    return result;
