 ...
 */
export declare function trackingStatusCreate(client: ShippoCore, carrier: string, trackingNumber: string, metadata?: string | undefined, options?: RequestOptions): Promise<Result<components.Track, SDKError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
//# sourceMappingURL=trackingStatusCreate.d.ts.map